...
public partial class VideoPlayerControl
{
    ...
    public static readonly DependencyProperty PlaybackEdnTimeProperty =
        DependencyProperty.Register("PlaybackEndTime", typeof(TimeSpan), typeof(VideoPlayerControl),
    ...
    public static readonly DependencyProperty PositionProperty =
        DependencyProperty.Register("Position", typeof(TimeSpan), typeof(VideoPlayerControl),
            new PropertyMetadata(TimeSpan.Zero));
    ...
    public static readonly DependencyProperty PositionSecondProperty =
        DependencyProperty.Register("PositionSecond", typeof(double), typeof(VideoPlayerControl),
    ...
    public static readonly DependencyProperty IsRepeatedProperty =
        DependencyProperty.Register("IsRepeated", typeof(bool), typeof(VideoPlayerControl),
    ...
    public static readonly DependencyProperty PlayPauseCommandProperty =
        DependencyProperty.Register("PlayPauseCommand", typeof(ICommand), typeof(VideoPlayerControl),
    ...
    public static readonly DependencyProperty MaximizeCommandProperty =
        DependencyProperty.Register("MaximizeCommand", typeof(ICommand), typeof(VideoPlayerControl),
            new UIPropertyMetadata(null));
    ...
    public static readonly DependencyProperty MuteCommandProperty =
        DependencyProperty.Register("MuteCommand", typeof(ICommand), typeof(VideoPlayerControl),
            new UIPropertyMetadata(null));
    ...
    public static readonly DependencyProperty OpenPlaylistCommandProperty =
        DependencyProperty.Register("OpenPlaylistCommand", typeof(ICommand), typeof(VideoPlayerControl),
            new UIPropertyMetadata(null));
    ...
    public static readonly DependencyProperty NextMediaCommandProperty =
        DependencyProperty.Register("NextMediaCommand", typeof(ICommand), typeof(VideoPlayerControl),
            new UIPropertyMetadata(null));
    ...
    public static readonly DependencyProperty PrevMediaCommandProperty =
        DependencyProperty.Register("PrevMediaCommand", typeof(ICommand), typeof(VideoPlayerControl),
            new UIPropertyMetadata(null));
