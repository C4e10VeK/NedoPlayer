...
namespace NedoPlayer.Utils.EventAggregator
{
    /// <summary>
    ...
    public class EventSubscription : IEventSubscription
    {
        ...
        public EventSubscription(IDelegateReference actionReference)
        {
            ...
            if (!(actionReference.Target is Action))
                throw new ArgumentException(string.Format(CultureInfo.CurrentCulture, "Invalid Delegate Rerefence Type Exception", typeof(Action).FullName), nameof(actionReference));
    ...
    public class EventSubscription<TPayload> : IEventSubscription
    {
        ...
        public EventSubscription(IDelegateReference actionReference, IDelegateReference filterReference)
        {
            ...
            if (!(actionReference.Target is Action<TPayload>))
                throw new ArgumentException(string.Format(CultureInfo.CurrentCulture, "Invalid Delegate Rerefence Type Exception", typeof(Action<TPayload>).FullName), nameof(actionReference));
